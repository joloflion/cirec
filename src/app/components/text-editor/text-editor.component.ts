...
declare let Quill: new (arg0: string, arg1: { theme: string; modules: { toolbar: (string[] | { header: (number | boolean)[]; }[] | { size: string[]; }[] | { list: string; }[])[]; }; }) => any; // declare Quill to make TypeScript happy :)
